...
export default function ParentProfilePage() {
  ...
  // Hardcode the role as parent since we're in the parent profile page
  const role = "parent";
  ...
  useEffect(() => {
    if (user) {
      ...
      setFormData({
        ...
        contactPreference: extendedUser.contactPreference || "Email",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await updateDoc(doc(db, "users", user.uid), { 
        ...
        avatarUrl: avatarUrl,
        // Preserve existing fields like role and children
        role: user.role
      });
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <h1 className="text-3xl font-orbitron font-bold text-primary mb-6">Edit Parent Profile</h1>
      
      <Card className="border-primary/20">
        <CardHeader>
          <CardTitle>Parent Information</CardTitle>
          <CardDescription>Update your contact details and communication preferences</CardDescription>
        </CardHeader>
